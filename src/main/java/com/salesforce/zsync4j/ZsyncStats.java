...
public interface ZsyncStats {
  ...
  public static class Observer extends ZsyncObserver {
    ...
    public void inputFileReadingStarted(Path inputFile, long length) {
      ...
      this.bytesReadBefore = totalBytesRead;
      this.bytesWrittenBefore = totalBytesWritten;
      this.bytesRead = 0;
    }
    ...
    public void inputFileReadingComplete() {
      ...
      this.bytesReadByInputFile.put(inputFile, totalBytesRead - bytesReadBefore);
      this.bytesWrittenByInputFile.put(inputFile, totalBytesWritten - bytesWrittenBefore);
      this.inputFile = null;
